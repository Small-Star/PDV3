...
def meditation_figs(data, height = 500, width = 1700):
	...
	#MA (inital values: 10;0;10;10;10;10;10)
	m_t_ma.append(10.0)
	m_t_ma.append(5.0)
	m_t_ma.append(6.67)
	m_t_ma.append(7.5)
	...
	for j in range(7,d['date'].count()):
		#print(d['date'][j],d['meditation_time'][j])
	...
	plot_daily.line('date', 'm_t_ma', name='m_t_ma', source=cds_w, line_color="#8B0A50", line_width=2, line_alpha=0.6, legend="Moving Average (7 days)")
